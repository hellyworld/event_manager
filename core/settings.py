...
SECRET_KEY = "django-insecure-*b-!@wz9heo18e3g0h_&u9xgktj6pz5ux29(rk2bey%*p5fz57"
...
SPECTACULAR_SETTINGS = {
    ...
    "register to attend app_events. Each event should have at least a name, a description, a start date, "
