# Contributing to Event Manager API
...
* You can try running `python -m black your_script.py` for auto-formatting
...
This document was adapted from the open-source contribution guidelines for [Facebook's Draft](https://
